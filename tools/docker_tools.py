...
@tool
def docker_logs(container_identifier: str):
    """
...
@tool
def inspect_container(container_identifier: str):
    """
...
@tool
def start_container(container_identifier: str):
    """
...
@tool
def stop_container(container_identifier: str):
    """
...
@tool
def restart_container(container_identifier: str):
    """
    Restart a container.
    Accepts container name or container ID.
    """
    ...
    return run_command(
        ["docker", "restart", container_identifier]
    )


@tool
def remove_container(container_identifier: str):
    """
    Remove a container.
    Accepts container name or container ID.
    """
